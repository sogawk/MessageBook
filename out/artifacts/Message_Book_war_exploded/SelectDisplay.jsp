...
<h3><a href="DisplayServlet" style="float: right">返回留言本首页</a></h3><br/><br/>
...
<span id="span1">
    ...
    <a href="SelectServlet?pp=1">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="SelectServlet?pp=<%=pageBean.getCurrentPage()-1%>">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
    当前为第<%=pageBean.getCurrentPage()%>/<%=pageBean.getTotalPage()%>页
    &nbsp;&nbsp;&nbsp;&nbsp;
    <a href="SelectServlet?pp=<%=pageBean.getCurrentPage()+1%>">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="SelectServlet?pp=<%=pageBean.getTotalPage()%>">末页</a>&nbsp;&nbsp;&nbsp;&nbsp;
    跳转到：<%
    for (int pp = 1; pp <= pageBean.getTotalPage(); pp++) {
%><a href="SelectServlet?pp=<%=pp%>"><%=pp%></a> &nbsp;<%
    }
%>
</span>
